...
let AlexaModules = require('whatsalexa-npm')
let Modules = AlexaModules.list(Config.LANG, message.client.user.jid)
...
if (hrs >= 12 && hrs <= 15) {
     wish = 'Wishing you a Healthy & Happy Fabulous Noon! Good Afternoon 🌞', wishml = 'നിങ്ങൾക്ക് ആരോഗ്യകരവും സന്തോഷകരവുമായ അതിശയകരമായ ഉച്ചഭക്ഷണം ആശംസിക്കുന്നു! ഗുഡ് ആഫ്റ്റർനൂൺ 🌞', wishid - 'Semoga Anda Sehat & Selamat Siang yang Luar Biasa! Selamat siang 🌞'
    
} else if (hrs >= 15 && hrs <= 19) {
    wish = 'May the setting sun take down all your sufferings with it and make you hopeful for a new day! Good Evening 🌥', wishml = 'അസ്തമയ സൂര്യൻ നിങ്ങളുടെ എല്ലാ കഷ്ടപ്പാടുകളും ഇല്ലാതാക്കുകയും ഒരു പുതിയ ദിവസത്തിനായി നിങ്ങളെ പ്രതീക്ഷിക്കുകയും ചെയ്യട്ടെ! ഗുഡ് ഈവനിംഗ് 🌥', wishid = 'Semoga matahari terbenam menghapus semua penderitaan Anda dengannya dan membuat Anda berharap untuk hari yang baru! Selamat malam 🌥'
    
} else if (hrs >= 19 && hrs <= 24) {
    wish = 'Touch your heart, close your eyes, make a wish & Sleep! Good night 🌙', wishml = 'നിങ്ങളുടെ ഹൃദയത്തിൽ സ്പർശിക്കുക, കണ്ണുകൾ അടയ്ക്കുക, നിങ്ങളുടെ മനസ്സിൽ ഒരു ആഗ്രഹം പറയുകയും ഉറങ്ങുകയും ചെയ്യുക! ശുഭ രാത്രി 🌙', wishid = 'Sentuh hatimu, pejamkan matamu, buat permohonan & Tidur! Selamat malam 🌙'
    
} else {
    wish = 'May today bring you the joys of yesterday’s hopes! Good Morning ⛅', wishml = 'ഇന്നലത്തെ പ്രതീക്ഷകളുടെ സന്തോഷം ഇന്ന് നിങ്ങൾക്ക് നൽകട്ടെ! സുപ്രഭാതം ⛅', wishid = 'Semoga hari ini membawakan Anda kegembiraan dari harapan kemarin! Selamat pagi ⛅'
}
